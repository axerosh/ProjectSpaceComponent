...
/**
 * An enity that requests VisibleEntityListeners to update their visual representation.
 * Each unique VisibleEntityListener may only be notified  onse per update request.
 */
